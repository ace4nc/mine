/* ============================================================
   ...
   Two sections were added to the original brief for you:
   - FAITH ("under the same sky"), just after the distance chapter
   - POETRY ("in another language"), just after the private language chapter
   Both are explained in the README under "Adding your own verses."
   ============================================================ */
...
window.CONTENT = {
  ...
  relationship: {
    ...
    relationshipStart: "2024-02-17",
    metDate: "17 February 2024",
  },

  // ----------------------------------------------------------
  // CHAPTER — UNDER THE SAME SKY (faith)
  // Sits right after "the distance." This is deliberately NOT
  // pre-filled with translated Qur'an text — translations belong
  // to their translators, and the exact wording is a personal
  // choice anyway. Pick your own translation (Sahih International,
  // Yusuf Ali, Mustafa Khattab's Clear Qur'an, or your own reading)
  // for each reference below and paste it into `text`. The
  // reference is left visible either way.
  // ----------------------------------------------------------
  faith: {
    eyebrow: "also, we pray",
    title: "under the same sky.",
    intro: "[One or two lines, in your own words, on what waiting on Allah has meant for the two of you.]",
    verses: [
      {
        id: "v1",
        reference: "Surah Yusuf, 12:18",
        theme: "for the waiting",
        text: "[Paste your preferred translation of \"fa-sabrun jameel\" / \"so patience is most fitting\" here.]",
      },
      {
        id: "v2",
        reference: "Surah Ar-Rum, 30:21",
        theme: "for the two of you",
        text: "[Paste your preferred translation about tranquility, love, and mercy placed between two hearts here.]",
      },
      {
        id: "v3",
        reference: "Surah Al-Baqarah, 2:286",
        theme: "for the hard nights",
        text: "[Paste your preferred translation about Allah not burdening a soul beyond what it can bear here.]",
      },
      {
        id: "v4",
        reference: "[Add a fourth reference that means something to you both, e.g. a du'a you say for each other]",
        theme: "[what it's for]",
        text: "[Text.]",
      },
    ],
    closing: "[A short closing line — a du'a for him, in your own words.]",
  },
  ...
  artifacts: [
    ...
    { id: "a6", type: "DATE", title: "17 February", date: "2024", body: "[Why this date, specifically.]" },
    ...
    { id: "a10", type: "PLACE", title: "Dal Lake", date: "[DATE]", body: "[Why this place means something, even though he hasn't seen it yet.]" },
  ],
    ...
    categories: [
      {
        ...
        items: [
          { id: "s1", title: "[SONG TITLE — maybe an Arijit Singh track]", note: "[Why it's ours.]", spotify: null, audio: null, duration: null },
  ...
  // ----------------------------------------------------------
  // CHAPTER — IN ANOTHER LANGUAGE (poetry)
  // Sits right after "our private language." Real Faiz Ahmed Faiz
  // and Ahmed Faraz verses are still under copyright — paste the
  // couplet you love into `excerpt` yourself (a few lines is
  // enough) rather than the whole ghazal. One original piece,
  // written for this page, is filled in below as a starting
  // anchor — replace or keep it as you like, and add "Khud se
  // Jung" here too if you want it on the page.
  // ----------------------------------------------------------
  poetry: {
    eyebrow: "chapter eight and a half",
    title: "in another language.",
    intro: "[A line or two on why Urdu says some things English can't.]",
    entries: [
      {
        id: "p1",
        poet: "Faiz Ahmed Faiz",
        workTitle: "[Name of the poem/ghazal]",
        excerpt: "[Paste the couplet you love — in Urdu script, Roman Urdu, or both.]",
        note: "[Why this one, and what it has to do with him.]",
      },
      {
        id: "p2",
        poet: "Ahmed Faraz",
        workTitle: "[Name of the poem/ghazal]",
        excerpt: "[Paste the couplet you love.]",
        note: "[Why this one.]",
      },
      {
        id: "p3",
        poet: "Aisha",
        workTitle: "Khud se Jung",
        excerpt: "[Paste a few lines of your own ghazal here, if you want it on the page.]",
        note: "[What it was actually about, for anyone reading who wasn't there when you wrote it.]",
      },
      {
        id: "p4",
        poet: "Aisha",
        workTitle: "for the one who is far",
        excerpt:
          "tu door hai magar mera hai, yeh baat itni seedhi hai\nnaqsha kehta hai faasla, dil kehta hai qareeb tha, qareeb hai\n\nyou are far but you are mine, it's a simple enough thing to say\nthe map says distance, the heart says close, has always been close",
        note: "Written for this page — not one of the greats, just something true, in the meantime.",
      },
    ],
  },
  ...
  // ----------------------------------------------------------
  littleThings: [
    { id: "l1", kind: "note", text: "[a smell or taste that reminds you of home in Srinagar]" },
    { id: "l2", kind: "note", text: "[something about Ottawa winters he's told you about]" },
    { id: "l3", kind: "note", text: "[a random memory]" },
    { id: "l4", kind: "note", text: "[a phrase one of you says too much]" },
    { id: "l5", kind: "note", text: "[a date that means something]" },
    { id: "l6", kind: "note", text: "[something dumb you argued about]" },
    { id: "l7", kind: "note", text: "[a nickname and where it came from]" },
    { id: "l8", kind: "note", text: "[a song lyric you both misheard the same way]" },
  ],
  ...
  ifYouWereHere: [
    ...
    { id: "i3", label: "IF YOU WERE SITTING NEXT TO ME", text: "[Scene — Dal Lake, a houseboat, whatever is true.]" },
  ...
  future: [
    ...
    { id: "f9", text: "pray next to each other", done: false },
  ...
  // ----------------------------------------------------------
  firstMeeting: {
    location: "[WHERE YOU IMAGINE MEETING — an airport, most likely]",
    time: "[TIME OF DAY]",
    weather: "[WEATHER]",
  ...
  timeCapsules: [
    ...
    { id: "tc3", label: "OPEN ON OUR THIRD ANNIVERSARY", message: "[Message.]", unlockDate: "2027-02-17" },
  ],
